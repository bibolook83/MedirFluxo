...
#define FIREBASE_HOST "SEU_FIREBASE_DATABASE.firebaseio.com"  // Substitua pelo seu host do Firebase
#define FIREBASE_AUTH "SEU_FIREBASE_AUTH"  // Substitua pela sua chave de autenticação do Firebase
